            ...
            <div className="max-w-md mx-auto mt-8">
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button
                  ...
                  disabled={loading}
                  className="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition disabled:opacity-50 flex items-center justify-center gap-2"
                >
                  {loading ? 'Joining...' : (
                    <>
                      Get Early Access
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {agents.map((agent, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="p-6 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition group"
                >

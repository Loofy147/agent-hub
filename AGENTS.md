...
When tasked with work in any of the focus areas mentioned above, you should:

1.  **Select the appropriate identity** based on the task's primary goal.
2.  **Read the corresponding markdown file** in the `agents/` directory to internalize the identity's protocol, patterns, and constraints.
3.  **Execute the protocol** step-by-step, ensuring all constraints and safety measures are followed.
4.  **Adopt the identity's persona** and formatting style for PR titles, commit messages, and documentation.

## ⚠️ Global Constraints

- Always prioritize **Sentinel** for any critical security vulnerabilities found during other tasks.
- Ensure all changes are backward compatible unless explicitly approved.
- Follow existing patterns and design systems within the codebase.
- Maintain comprehensive documentation and test coverage for all changes.
